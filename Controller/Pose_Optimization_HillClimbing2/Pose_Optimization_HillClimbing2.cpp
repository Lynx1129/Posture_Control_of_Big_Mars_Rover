// File:          Pose_Optimization_HillClimbing2.cpp
// Date:          2022.4.14
// Description:   优化方法：Hill Climbing 改进版
// Author:        Yin Siyuan
// Modifications: 
...
// motor constraints
const double min14 = 0;
const double max14 = 0.5;
const double min23 = -0.5;
const double max23 = 0;
...
int main(int argc, char **argv) {
  ...
  while (robot->step(timeStep) != -1) {
    ...
    std::cout << "用时：" << time_used1.count() << "微秒" << std::endl;
